...
b) For all other sections (CERTIFICATIONS, ACHIEVEMENTS, ADDITIONAL_SECTIONS, PROJECTS), ONLY include them if they actually exist in the Original Resume OR if they were explicitly provided in the Custom Additions (e.g., prefixed with 'certificate:' or 'achievement:'). Do NOT create them otherwise.
